...
public class Bancointer {
	...
	public void screnShot (String nome) {
	}	
	WebDriver driver;
	@Before
	public void setUp() throws Exception {
		
		// codigo pra abrir o 4devs
		...
		String numero = driver.findElement(By.id("telefone_fixo")).getText();
	...
	Thread.sleep(3000);
		...
		driver.findElement(By.id("celular")).sendKeys(numero);
	 ...
	 Files.copy(f, new File ("C:\\Users\\ferna\\Pictures\\Eclipse\\interscreenshot.jpg"));
